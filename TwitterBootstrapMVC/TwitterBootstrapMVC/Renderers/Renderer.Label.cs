...
namespace TwitterBootstrapMVC.Renderers
{
    internal static partial class Renderer
    {
        public static string RenderLabel(HtmlHelper html, BootstrapLabelModel model)
        {
            ...
            //if (!model.showRequiredStar || !model.showRequiredStar && !model.metadata.IsRequired)
            ...
            //+ requiredSpan.ToString()
            label.InnerHtml = innerinput + model.labelText  + model.innerValidationMessage;
